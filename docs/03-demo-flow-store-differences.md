...
**The back office differs too.** Top bar, far right → **🔒 Espace caviste** → open **Paris**: dashboard with real revenue,
...
7. Top bar → **🔒 Espace caviste** → **Paris** dashboard, then **Nantes** padlocks. *(40 s)*
